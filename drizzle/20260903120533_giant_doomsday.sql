CREATE TABLE "job_executions" (
	...
	"error_code" text,
	"correlation_id" text,
	CONSTRAINT "job_executions_job_name_allowlist_check" CHECK ("job_executions"."job_name" in (
		's11.job.heartbeat',
		's11.backup.logical'
	)),
	CONSTRAINT "job_executions_status_allowlist_check" CHECK ("job_executions"."status" in (
		'RUNNING',
		'SUCCEEDED',
		'FAILED',
		'SKIPPED_IDEMPOTENT'
...
CREATE INDEX "job_executions_job_name_started_at_idx" ON "job_executions" USING btree ("job_name","started_at");